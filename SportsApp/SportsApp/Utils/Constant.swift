...
class Constant {
    // all Nib names
   static let  upcomingCellNibName="CollectionViewCell"
   static let  teamCellNibName="TeamsCollectionViewCell"
   static let  latestResultCellNibName="LatestResultCollectionViewCell"
    static let  topBannerNibName = "TopBanner"
    static let headerNibName="HeaderReusableView"
